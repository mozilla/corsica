...
function Corsica() {
  ...
  var templatePath = path.resolve(path.join(__dirname, '..', 'templates'));
  var templateLoader = new nunjucks.FileSystemLoader(templatePath);
  this.nunjucks = new nunjucks.Environment(templateLoader);
